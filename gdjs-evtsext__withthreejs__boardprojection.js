...
gdjs.evtsExt__WithThreeJS__BoardProjection.BoardProjection.prototype.doStepPostEventsContext.userFunc0x1c10798 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__WithThreeJS__BoardProjection.BoardProjection.prototype.doStepPostEventsContext.userFunc0x1c10798(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
...
};gdjs.evtsExt__WithThreeJS__BoardProjection.BoardProjection.prototype.doStepPostEventsContext.userFunc0x1918c50 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if (!gdjs.__WithThreeJS.has("Renderer")) {
    console.warn("!");
    return;
...
if (ViewMode === "Built-In 3D") {
    Obj.scale.set(objects[0].getScaleX(), objects[0].getScaleY() * -1, 1);
} else {
...
let Angle;
if (ViewMode === "Built-In 3D") {
    BaseXAngle = (Orientation == "Vertical") ? -90 : 0;
    Angle = (AngleAxis == "Y Axis") ? objects[0].angle * -1 : objects[0].angle;
} else {
    BaseXAngle = (Orientation == "Horizontal") ? -90 : 0;
    Angle = objects[0].angle * -1;
}
if (AngleAxis == "X Axis") {
...
gdjs.evtsExt__WithThreeJS__BoardProjection.BoardProjection.prototype.doStepPostEventsContext.userFunc0x1918c50(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
...
gdjs.evtsExt__WithThreeJS__BoardProjection.BoardProjection.prototype.onDestroyContext.userFunc0x9af5e0 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__WithThreeJS__BoardProjection.BoardProjection.prototype.onDestroyContext.userFunc0x9af5e0(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
